...
export class WeaponMaterials {
  ...
  /** Used if the materials subsystem is unavailable (standalone harness). */
  _fallback(key) {
    ...
    switch (key) {
      case 'alu':
      case 'alu_tan':
        color = key === 'alu_tan' ? 0x8a7a60 : 0x1f2329;
        roughness = 0.52;
        metalness = 0.55;
        break;
      case 'steel':
      ...
      case 'poly':
      case 'poly_tan':
        color = key === 'poly_tan' ? 0x72634e : 0x16181d;
        roughness = 0.78;
        metalness = 0.12;
        break;
      case 'rubber':
      ...
      case 'glove_seam':
        ...
        break;
      case 'sleeve':
        color = 0x363d33; // Tactical olive ripstop
        roughness = 0.88;
        metalness = 0.02;
        break;
      default:
